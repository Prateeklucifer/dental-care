...
export default function Hero() {
    const image = ["/services-6.webp", "/services-1.webp", "/services-4.webp"]
            ...
            <div className="container px-4 md:px-0 m-auto">
                ...
                <div className="relative overflow-hidden rounded-lg bg-black">
                    <div className="absolute top-0 z-10 flex w-full h-full justify-center items-center flex-col text-white gap-3">
                        <div className="heading font-semibold text-lg px-7 text-center sm:text-xl md:text-2xl lg:text-3xl">Transform Your Smile!</div>
                        <div className="para px-10 text-center sm:px-10 md:px-28 lg:text-lg lg:px-36 xl:px-64">Achieve your best smile with our tailored dental services. We prioritize your comfort and satisfaction at Dental Cure.</div>
                    </div>
